...
FM_CREW_STATE_NOTE_MAX=400    # max chars of a crew status note kept in fm-crew-state.sh's one-line read
FM_SANITIZE_MAX=2000         # default char bound the shared untrusted-crew-text sanitizer applies (per-call arg can override)
